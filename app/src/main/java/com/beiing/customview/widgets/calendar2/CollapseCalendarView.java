package com.beiing.customview.widgets.calendar2;
...
import com.beiing.customview.widgets.calendar2.manager.Day;
import com.beiing.customview.widgets.calendar2.manager.Formatter;
import com.beiing.customview.widgets.calendar2.manager.Month;
import com.beiing.customview.widgets.calendar2.manager.ResizeManager;
import com.beiing.customview.widgets.calendar2.manager.Week;
import com.beiing.customview.widgets.calendar2.widget.DayView;
import com.beiing.customview.widgets.calendar2.widget.WeekView;
...
public class CollapseCalendarView extends LinearLayout implements View.OnClickListener {
    ...
    private void populateWeekLayout(@NonNull Week week, @NonNull WeekView weekView) {
		...
		for (int i = 0; i < 7; i++) {
			...
			DayView tvChinaDay = (DayView) layout
					.findViewById(R.id.tvChinaDay);
